...
class AccountMoveLine(models.Model):
    ...
    def check_full_reconcile(self):
        ...
        if (
            ...
            # Eventually create a journal entry to openacademy the difference due to foreign currency's exchange rate that fluctuates
...
class AccountPartialReconcile(models.Model):
    ...
    def create_exchange_rate_entry(self, aml_to_fix, move):
        """
        Automatically create a journal items to openacademy the exchange rate
...
class AccountFullReconcile(models.Model):
    ...
    @api.multi
    def unlink(self):
        """ When removing a full reconciliation, we need to revert the eventual journal entries we created to openacademy the
